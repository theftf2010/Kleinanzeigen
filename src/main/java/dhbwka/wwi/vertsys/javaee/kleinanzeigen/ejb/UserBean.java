...
public class UserBean {
     ...
     */
    public void signup(String username, String password, String vorname, String nachname,
        String telefonnummer, String email, String adresse, String postleitzahl, String stadt) throws UserAlreadyExistsException {
        if (em.find(User.class, username) != null) {
            throw new UserAlreadyExistsException("Der Benutzername $B ist bereits vergeben.".replace("$B", username));
        }

        User user = new User(username, password ,vorname, nachname,
        telefonnummer, email, adresse, postleitzahl,stadt);
